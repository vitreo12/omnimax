...
if(NOT MSVC)
	...
	if(WIN32)
		set(CMAKE_C_FLAGS_RELEASE   "-O3 -s -DNDEBUG -march=${BUILD_MARCH} -mtune=${BUILD_MARCH}")
		set(CMAKE_CXX_FLAGS_RELEASE "-O3 -s -DNDEBUG -march=${BUILD_MARCH} -mtune=${BUILD_MARCH}")
	else()
